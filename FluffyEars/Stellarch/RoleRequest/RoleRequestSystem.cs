...
namespace BigSister.RoleRequest
{
    static partial class RoleRequestSystem
    {
        ...
        internal static async Task MessageReactionAdded(MessageReactionAddEventArgs e)
            => await HandleTakeGiveRole(true, e.Guild, e.User, e.Channel, e.Message, e.Emoji);

        internal static async Task MessageReactionRemoved(MessageReactionRemoveEventArgs e)
